...
export const BureauRoomBackdrop: React.FC<BackdropProps> = ({ roomName = '', children }) => {
  ...
  return (
    <div className="relative min-h-dvh w-full overflow-x-hidden bg-[#d9cba7] text-[#263238] flex flex-col font-['Plus_Jakarta_Sans'] lg:h-dvh lg:overflow-hidden">
      ...
      <div className="relative z-20 min-h-0 flex-1 flex flex-col w-full max-w-[1480px] mx-auto px-3 sm:px-6 py-3 sm:py-5">
        <div className="relative min-h-0 flex-1 flex flex-col rounded-[30px] border-[4px] border-[#7e5c24] bg-[#fff7df]/80 backdrop-blur-[2px] shadow-[0_12px_0_#7b4f32,0_24px_55px_rgba(57,43,29,.26)] overflow-hidden">
          ...
          <div className="relative min-h-0 flex-1 flex flex-col p-3 sm:p-5 pt-5 sm:pt-7">
            {children}
          </div>
        </div>
      </div>
